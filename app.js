...
function sumArray(arr) { //eslint-disable-line
    ...
    var totalSum = sum(total[0],arr[2])
    list.push(totalSum[0])
    list.push(`${arr[0]},${arr[1]},${arr[2]} was passed in as an array of numbers, and ${totalSum[0]} is their sum.`)
    return list;
...
function multiplyArray(multArr) { //eslint-disable-line
    var list =[];
    var total =  multiply(multArr[0], multArr[1]);
    var totalSum = multiply(total[0],multArr[2])
    list.push(totalSum[0])
    list.push(`The numbers ${multArr[0]},${multArr[1]},${multArr[2]} have a product of ${totalSum[0]}.`)
    console.log(list);
    return list;
